...
export class SickleUI {
    ...
    private currentScreenSize = SICKLE_BUTTON_MIN_PIXELS;
    ...
    constructor(inputElement: HTMLElement, camera: THREE.PerspectiveCamera, pixiUI: PixiUI) {
        ...
        this.sprite.alpha = SICKLE_BUTTON_OPACITY;
    ...
    private async loadTexture() {
        try {
            const texture = await Assets.load<Texture>(SICKLE_BUTTON_TEXTURE_PATH);
